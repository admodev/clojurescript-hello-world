...
var seq__1162_1166 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1163_1167 = null;
var count__1164_1168 = (0);
var i__1165_1169 = (0);
while(true){
if((i__1165_1169 < count__1164_1168)){
var str_1170 = cljs.core._nth.call(null,chunk__1163_1167,i__1165_1169);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1170})));


var G__1171 = seq__1162_1166;
var G__1172 = chunk__1163_1167;
var G__1173 = count__1164_1168;
var G__1174 = (i__1165_1169 + (1));
seq__1162_1166 = G__1171;
chunk__1163_1167 = G__1172;
count__1164_1168 = G__1173;
i__1165_1169 = G__1174;
continue;
} else {
var temp__5535__auto___1175 = cljs.core.seq.call(null,seq__1162_1166);
if(temp__5535__auto___1175){
var seq__1162_1176__$1 = temp__5535__auto___1175;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1162_1176__$1)){
var c__5215__auto___1177 = cljs.core.chunk_first.call(null,seq__1162_1176__$1);
var G__1178 = cljs.core.chunk_rest.call(null,seq__1162_1176__$1);
var G__1179 = c__5215__auto___1177;
var G__1180 = cljs.core.count.call(null,c__5215__auto___1177);
var G__1181 = (0);
seq__1162_1166 = G__1178;
chunk__1163_1167 = G__1179;
count__1164_1168 = G__1180;
i__1165_1169 = G__1181;
continue;
} else {
var str_1182 = cljs.core.first.call(null,seq__1162_1176__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1182})));


var G__1183 = cljs.core.next.call(null,seq__1162_1176__$1);
var G__1184 = null;
var G__1185 = (0);
var G__1186 = (0);
seq__1162_1166 = G__1183;
chunk__1163_1167 = G__1184;
count__1164_1168 = G__1185;
i__1165_1169 = G__1186;
continue;
}
} else {
}
...
var onload = (function (){
if(cljs.core.truth_((function (){var and__4678__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__1191 = script;
goog.object.set(G__1191,"type","text/javascript");

goog.object.set(G__1191,"onload",onload);

goog.object.set(G__1191,"onreadystatechange",onload);

return G__1191;
})();
if((opt_sourceText == null)){
var G__1192 = script__$1;
goog.object.set(G__1192,"src",src);

return G__1192;
} else {
var G__1193 = script__$1;
goog.dom.setTextContent(G__1193,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__4689__auto__ = reload;
...
var path_1194 = goog.debugLoader_.getPathFromDeps_(src);
goog.object.remove(goog.debugLoader_.written_,path_1194);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1194)].join(''));
} else {
var path_1195 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_1195);

goog.object.remove(goog.dependencies_.written,path_1195);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1195)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1196 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1197 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1197);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1196);
}})()})));
}));
